      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You are logged out');
              setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFraHRpeW9yam9uIiwiYSI6ImNsM2VscDgxczBqYnczZHB2NnVlNGVmNDgifQ.yjnHf7OIh1IzChbb1lakag';
  ...
  locations.forEach(function (loc) {
    ...
    htmlEl.className = 'marker'; // Add marker
    ...
    new mapboxgl.Popup({
      offset: 28
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe("pk_test_51L7BSQAAxAOnpsobTEhxpDzeNloMJIFNN8vMAvyWY2yoiCoVIKJKJEWQY8qTW1uQ7dqq47w554txO039Z71O9ByM00JzeBJvAg"); // 1) Get the session from the server(API)
...
exports.updateUserSettings = exports.updateUserPassword = exports.updateUserData = void 0;
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(currentPassword, password, passwordConfirm) {
    var result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your password is updated');
              setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(type, data) {
    var url, result;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " is updated!"));
              setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
if (loginForm) {
  document.querySelector('.form--login').addEventListener('submit', function (e) {
    e.preventDefault(); // DOM elements related to  login
...
if (userForm) {
  userForm.addEventListener('submit', function (e) {
    ...
    (0, _update.updateUserSettings)('data', form); // updateUserData(name, email);
  });
...
if (userSettingsForm) {
  userSettingsForm.addEventListener('submit', function (e) {
    ...
    (0, _update.updateUserSettings)('password', data); // updateUserPassword(currentPassword, password, passwordConfirm);
  });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7909" + '/');
